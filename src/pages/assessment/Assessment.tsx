        ...
        <div>
            <div className="container">
                <Box component="form" noValidate autoComplete="off">
                    ...
                    <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                        <TextField id="outlined-basic" label="Chỗ ở hiện tại" variant="outlined" />
                        <TextField
                            id="outlined-basic"
                    ...
                    <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            >
                                ...
                                />
                                <FormControlLabel value="7" control={<Radio />} label="Mục khác" />
                            </RadioGroup>
                        </div>
                        <div>
                            <FormLabel id="demo-radio-buttons-group-label">
                    ...
                    <div className="mt-5">
                        <div>
                            ...
                            <FormGroup>
                                <FormControlLabel control={<Checkbox />} label="CMND/CCCD" />
                                <FormControlLabel
                                    control={<Checkbox />}
                    ...
                    <div className="mt-5">
                        <div>
                            ...
                            <FormGroup>
                                ...
                                />
                                <FormControlLabel control={<Checkbox />} label="Đăng ký kết hôn" />
                                <FormControlLabel
                                    control={<Checkbox />}
